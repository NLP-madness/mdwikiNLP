...
#####HERE######
  ...
  def classify(self, words):
    ...
    """
    countTotalReviews                                              ### Count of total reviews 
    probPos                                                        ### Prior of positive reviews
    probNeg                                                        ### Prior of negative reviews
    
    
    pos_words                                                      ### Get list of all positive words from self.posText
    neg_words                                                      ### Get list of all negative words from self.negText
    self.shared_vocab                                              ### Get intersection of pos and neg words 
    self.train_vocab                                               ### Get union of pos and neg words from training set 

  


    words = words if not self.BOOLEAN_NB else                       ### Implement BOOLEAN_NB here 
    words = words if not self.BEST_MODEL else                       ### Implement BEST_MODEL here 
    words = words if not self.FILTER_STOP_WORDS                     ### Implement stop word filtering here 
    ...
    return 'pos'                                                   ### return 'pos' if pos_guess > neg_guess else 'neg'
  ...
  def addExample(self, klass, words):
    ...
    words = words if not self.BOOLEAN_NB else                       ### Implement BOOLEAN_NB here 
    words = words if not self.BEST_MODEL else                       ### Implement BEST_MODEL here 
    words = words if not self.FILTER_STOP_WORDS else                ### Implement stop word filtering here 
